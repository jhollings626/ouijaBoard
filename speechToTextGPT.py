...
while(1): #wait for user to speak
    ...
    try:
        ...
        with sr.Microphone() as source2:
            ...
            MyText = r.recognize_vosk(audio2) #can switch vosk to google, but only 50 calls/day
            MyText = MyText.lower()
            
            if vosk:
                parsedHeard = MyText.split('"')[3] #remove additional formatting when vosk recognition is used
            else:
                parsedHeard = MyText

            print("Unformatted: ", MyText)
